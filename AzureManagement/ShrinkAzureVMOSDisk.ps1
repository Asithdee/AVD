# Variables
$DiskID = "/subscriptions/45f715fc-56b2-44ed-9e69-8250d36d2d89/resourceGroups/RG-AZUREARC/providers/Microsoft.Compute/disks/ArcBox-Client-OSDisk"
$VMName = "ArcBox-Client"
$DiskSizeGB = 256
$AzSubscription = "ME-MngEnvMCAP855772-adesilva-1"
