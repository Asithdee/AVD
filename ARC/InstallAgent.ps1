...
try {
    ...
    $ServicePrincipalId="742b19ae-6dc9-4824-9442-442ca8e07fe8";
    $ServicePrincipalClientSecret="AddSecret";

    $env:SUBSCRIPTION_ID = "45f715fc-56b2-44ed-9e69-8250d36d2d89";
    $env:RESOURCE_GROUP = "RG-AzureARC";
    $env:TENANT_ID = "ebee1ab4-22a2-4a43-935b-b193f7535d4c";
    $env:LOCATION = "eastus2";
    $env:AUTH_TYPE = "principal";
    $env:CORRELATION_ID = "7ed93fbd-13ea-46b3-86da-e3a14fe50795";
